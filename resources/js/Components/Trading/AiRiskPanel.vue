    ...
    <section class="ai-risk relative overflow-hidden rounded-2xl border border-white/10 bg-dark-900/50">
        ...
        <div v-else class="relative p-5 pt-4 space-y-4">
            ...
            <div>
                ...
                <!--
                    แผงนี้เป็นข้อมูลระดับตลาด คิดตามโหมดข่าวที่แนะนำ — แต่ละบอทเลือกโหมดข่าวเองได้
                    (ปิดข่าว / แค่งดเปิดไม้ / ขายทันที) ไม่บอกไว้ ผู้ใช้จะเห็น "บังคับเทออก: เปิด"
                    แล้วงงว่าทำไมบอทที่ปิดข่าวไว้ไม่ขาย
                -->
                <p class="mt-2 text-[10px] text-dark-500 leading-relaxed">{{ t('aiTrade.riskModeNote') }}</p>
            </div>
