...
return [
    ...
    */
    ...
    // cast เป็น int เสมอ: env() คืนค่าเป็น string ทุกครั้งที่ตั้งไว้ใน .env
    // ทำให้ชนิดของค่านี้ไม่คงที่ (int 56 เมื่อใช้ค่า default, string '56' เมื่อ
    // .env ถูกโหลด) — เทียบแบบ === กับ chain id ที่เป็น int จะพลาดเงียบๆ
    'default' => (int) env('DEFAULT_CHAIN_ID', 56),
