...
/*
 * บอท Discord — ส่งข่าว วิดีโอ กฎ whitepaper และสถานะการขายเหรียญเข้าเซิร์ฟเวอร์ชุมชน ทุก 10 นาที
 *
 * ปิดสวิตช์ที่ /admin/discord = คำสั่งนี้ไม่แตะ Discord เลย (ค่าตั้งต้นคือปิด)
 * สถานะการขายแก้ข้อความเดิมเฉพาะเมื่อข้อมูลเปลี่ยนจริง — ไม่โพสต์ซ้ำทุกรอบ
 * รอบนี้ยังอุ่นแคชความพร้อมของการขาย (15 นาที) ให้ /ขายเหรียญ และผู้ช่วย AI ตอบได้ทันใจ
 */
