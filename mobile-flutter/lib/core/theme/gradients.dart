...
class AppGradients {
  ...
  static LinearGradient get brand => gold;

  /// Brand alt (LEGACY) → softer gold (highlight → mid)
  static LinearGradient get brandAlt => LinearGradient(
  ...
  static LinearGradient get portfolioCard => gold;
  ...
  static LinearGradient get metalSheen => LinearGradient(
  ...
  static LinearGradient get appBackgroundBase => LinearGradient(
    colors: [
  ...
  static RadialGradient get appBackgroundGlow => RadialGradient(
  ...
  static LinearGradient get darkBg => appBackgroundBase;

  /// Buy gradient — green, linear(160deg #62e6b4 → #34c98e)
  static LinearGradient get buy => LinearGradient(
  ...
  /// Sell gradient — red
  static LinearGradient get sell => LinearGradient(
  ...
  static LinearGradient get brandOverlay => LinearGradient(
