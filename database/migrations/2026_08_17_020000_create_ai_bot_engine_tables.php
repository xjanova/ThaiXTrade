...
return new class() extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('ai_bot_positions')) {
        ...
        if (! Schema::hasTable('ai_bot_trades')) {
