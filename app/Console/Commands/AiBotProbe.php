...
class AiBotProbe extends Command
{
    ...
    private function scenarios(): array
    {
        return [
            ...
            /*
             * ย่อ "ในขาขึ้น" — ฉากที่สวนค่าเฉลี่ยทำเงินจริง และเป็นฉากเดียวที่มันควรซื้อ
             *
             * หลังเพิ่มตัวกรองเทรนด์ใหญ่ (2 ก.ย. 2026) ฉาก "ขาลงสม่ำเสมอ" กับ
             * "ย่อลึกในกรอบ" ถูกปฏิเสธโดยตั้งใจ (ราคาอยู่ใต้ EMA 200 = มีดตก) ถ้าไม่มี
             * ฉากนี้ probe จะสรุปผิดว่ากลยุทธ์ไม่เคยลงมือเลย ทั้งที่มันแค่เลือกฉาก
             */
            'ย่อในขาขึ้น' => $this->candles(array_merge($this->trend(280, 100.0, 0.2), $this->trend(12, 156.0, -1.0))),
