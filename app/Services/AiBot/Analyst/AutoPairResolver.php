...
class AutoPairResolver
{
    ...
    public function resolve(AiBotConfig $bot, ?AiBotPlan $plan, bool $hasPosition): array
    {
        ...
        /*
         * AI ที่ยังทายไม่ดีกว่าโยนเหรียญ ไม่มีสิทธิ์เลือกเหรียญให้บอท (ด่านเดียวกับเข้า/ออกไม้)
         * ออดิท R3: เหรียญที่ AI ให้ buy แพ้ BTC เฉลี่ย −98 bps ใน 24 ชม. — ย้ายตามคือพาเงิน
         * ไปเหรียญที่แย่กว่าคู่เดิม ส่วน BTC ถูกจัดอันดับหนึ่ง 121/123 รอบจนแทบไม่เคยย้ายอยู่แล้ว
         */
        if ($demotion = $this->gate->demotion()) {
            return $stay($demotion);
        }
