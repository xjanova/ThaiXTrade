...
class PriceFeedService
{
    ...
    /*
     * สกุลที่ผูกกับดอลลาร์ 1:1 — ไม่ต้องไปถามราคาจากตลาด
     *
     * 'USD' อยู่ในนี้ด้วยเพราะรอบขายรับชำระเป็นเงินสด (บัตร/โอน) แล้ว
     * ถ้าไม่มี ระบบจะพยายามไปดึง "ราคาของ USD" จากตลาดคริปโตซึ่งไม่มีอยู่จริง
     * แล้วโยน exception ทำให้คำนวณจำนวนเหรียญไม่ได้เลยสักรายการ
     */
    private const STABLECOINS = ['USD', 'USDT', 'BUSD', 'USDC', 'DAI'];
