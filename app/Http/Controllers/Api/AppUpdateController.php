...
class AppUpdateController extends Controller
{
    ...
    public function notifyRelease(Request $request): JsonResponse
    {
        ...
        // ไม่ล็อก tag ให้อัตโนมัติอีกแล้ว
        //
        // เดิมล็อกทุกครั้งที่ CI แจ้ง พอวันหนึ่ง CI แจ้งไม่สำเร็จ ค่าที่ล็อกไว้ก็ค้าง
        // แล้วไม่มีอะไรมาปลด เว็บโฆษณารุ่นเก่าให้ทุกคนอยู่เป็นเดือนโดยไม่มีใครรู้
        // (เจอจริง 2026-08-23: แอปเทรดค้างที่ v1.1.66 ทั้งที่ปล่อยถึง v1.1.141 แล้ว
        //  วอลเล็ตค้าง v1.13.12 · มาสเตอร์โหนดค้าง v1.12.0)
        //
        // ค่าเริ่มต้นตอนนี้คือ "release ล่าสุดที่ไฟล์ครบ" ซึ่งไม่มีวันค้าง
        // ถ้าจะล็อกจริงต้องส่ง pin=1 มาอย่างจงใจ
        if ($tag && $request->boolean('pin')) {
