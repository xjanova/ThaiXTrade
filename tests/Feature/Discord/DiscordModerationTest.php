...
class DiscordModerationTest extends TestCase
{
    ...
    public function test_the_permission_check_names_what_the_bot_still_lacks(): void
    {
        ...
        $this->assertSame(['Timeout Members (ปิดเสียง)', 'Kick Members (เตะ)', 'Ban Members (แบน)', 'Manage Messages (ลบข้อความจากการ์ดรายงาน)', 'Pin Messages (ปักหมุดคู่มือ · การ์ดราคา)'], $json['missing']);
